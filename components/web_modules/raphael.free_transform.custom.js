 ...
 *  Not Original Script
 *
 *  - added preventRotateOnShiftPress option
 */
    ...
    ft.showHandles = function() {
      ...
      handles.map(function(handle) {
        handle.element.drag(function(dx, dy, x, y, e) {
          ...
          if ( handle.rotate && !(ft.opts.preventRotateOnShiftPress && e.shiftKey) ) {
      ...
      if ( rotate || scale ) {
        subject.drag(function(dx, dy, x, y, e) {
          var
            rad, radius,
            mirrored = {
              x: ft.o.scale.x < 0,
          ...
          if ( rotate  && !(ft.opts.preventRotateOnShiftPress && e.shiftKey) ) {
